...
namespace Dot_myCovid19app.Controllers
{
    public class VideoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,URL,Description")] Video video)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,URL,Description,UserId,Createddate,Modifieddate")] Video video)
        {
            if (ModelState.IsValid)
            {
                video.Modifieddate = DateTime.Now;
